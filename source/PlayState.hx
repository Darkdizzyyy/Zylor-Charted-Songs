...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt = new FlxText(STRUM_X + (FlxG.width / 2) - 248, 13, 400, "", 32);
		...
		timeBarBG.y = 19 + (timeTxt.height / 4);
		...
		timeBarBG.yAdd = -4;
		add(timeBarBG);
		if(ClientPrefs.downScroll) timeBarBG.y = FlxG.height - 22;
		...
		if(ClientPrefs.downScroll) timeBar.y = FlxG.height - 22;
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') {
			...
			scoreTxt.text = 'Score: ' + songScore + ' | Misses: ' + songMisses + ' | Accuracy: ' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%';//dave and bambi scoretxt go brrrrr
		}

		if(cpuControlled) {
			scoreTxt.text = 'Noob Mode | [Botplay]';
		}
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'Toggle Eyesores':
				var eyesores:Int = Std.parseInt(value1);
				switch (eyesores)
				{
                    case 0:
						shakeCam = false;
